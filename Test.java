...
class CharacterSheet implements Serializable {
    ...
    String char_name;
    String char_class; // "fighter", "theif", etc
    String player_name; 
    String 
...
public class Test {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        */
        ...
        System.out.print("Enter the character class (fighter, theif, mage, healer): ");
        ...
        // Serializing 'tracker'
        FileOutputStream fos = new FileOutputStream("new_charsheet.data");
        ObjectOutputStream oos = new ObjectOutputStream(fos);
        oos.writeObject(tracker);

        // De-serializing 'tracker'
        FileInputStream fis = new FileInputStream("new_charsheet.data");
